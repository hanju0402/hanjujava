	...
	private void addListener() {
		...
		SignUpNameTxt.addKeyListener(new KeyAdapter() {
	          ...
	          public void keyReleased(KeyEvent e) {
	        	  SignUpNameTxt.setText(CheckMethod.nameCheck(SignUpNameTxt.getText()));    
	          }
	       });	
		...
		SignUpIDTxt.addKeyListener(new KeyAdapter() {
			@Override // 
			public void keyReleased(KeyEvent e) {
				SignUpIDTxt.setText(CheckMethod.IdCheck(SignUpIDTxt.getText()));
		...
		SignUpTelTxt.addKeyListener(new KeyAdapter() {
			...
			public void keyReleased(KeyEvent e) {
				CheckMethod.PhoneCheck1(SignUpTelTxt.getText(), SignUpTelTxt, e);
			}
		});
		...
		SignUpTelTxt2.addKeyListener(new KeyAdapter() {
			...
			@Override// 전화번호 앞번호 텍스트 주민번호랑 같은 원리
			public void keyReleased(KeyEvent e) {
				CheckMethod.PhoneCheck2(SignUpTelTxt2.getText(), SignUpTelTxt2, e);
			}
		});
		...
		SignUpTelTxt3.addKeyListener(new KeyAdapter() {
			...
			@Override// 전화번호 앞번호 텍스트 주민번호랑 같은 원리
			public void keyReleased(KeyEvent e) {
				CheckMethod.PhoneCheck3(SignUpTelTxt3.getText(), SignUpTelTxt3, e);
			}
		});
