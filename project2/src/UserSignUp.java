...
public class UserSignUp extends JDialog {
	...
	private JComboBox SignUpAdressCom;
	private JPanel pnl;
	
	
	private String userId;
	private String userpw;
	private String userAdrres;
	private String userName;
	private String userPhone;
	private String userDetailAdrres;
...
//				}
				...
				// 상세주소 입력창이 비어있을때
				else if (SignUpAdress2Txt.getText().length() <= 0) {
